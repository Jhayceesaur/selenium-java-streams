...
public class CustomSeleniumStreamsMapper 
{
	public static void main(String[] args) 
	{
		...
		List <String> price = itemList.stream().filter(s->s.getText().contains("Beans")).map(s->getItePrice(s)).collect(Collectors.toList());
